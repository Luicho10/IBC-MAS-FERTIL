...
function LogoHeader() {
  return <header className="document-header">
    <img src={`${import.meta.env.BASE_URL}logo-mas-fertil-v2.svg`} alt="másfertil fertilizantes" className="mas-logo" />
  ...
  return <div className="app-shell">
    <header className="app-header no-print">
      <div className="brand-block">
        <img src={`${import.meta.env.BASE_URL}logo-mas-fertil-v2.svg`} alt="másfertil fertilizantes" className="app-logo" />
      </div>
    ...
    <div className="workspace">
      <aside className="sidebar no-print">
        ...
        <div className="sidebar-brand"><img src={`${import.meta.env.BASE_URL}logo-mas-fertil-v2.svg`} alt="MAS FERTIL" /></div>
      </aside>
